...
public class Flare: NSObject {
    ...
    public var flareInfo: JSONDictionary {
        ...
        info[self.flareClass.lowercased()] = self.id as AnyObject
        return info
    }
...
public class Environment: Flare, FlarePerimeter {
    ...
    public override init(json: JSONDictionary) {
        ...
        self.perimeter = getRect(json: json.getDictionary(key: "perimeter"))
    ...
    public override func setDistanceFrom(currentPosition latlong: CGPoint) {
        self.distance = self.geofence.distanceFrom(latlong: latlong)
    }
...
public class Thing: Flare, FlarePosition {
    ...
    public override init(json: JSONDictionary) {
        ...
        self.position = getPoint(json: json.getDictionary(key: "position"))
