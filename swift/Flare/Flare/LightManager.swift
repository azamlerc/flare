...
public class LightManager: APIManager {
    ...
    public func getLight(handler: @escaping (JSONDictionary) -> Void) {
    ...
    public func setPower(on: Bool, handler: @escaping (JSONArray) -> Void) {
    ...
    public func setColor(hue: Int, saturation: Int, brightness: Int, handler: @escaping (JSONArray) -> Void) {
