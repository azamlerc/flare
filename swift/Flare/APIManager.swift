...
public class APIManager: NSObject {
    ...
    public func sendRequestDetailed(uri: String,
        ...
        handler: @escaping (AnyObject, NSURLRequest, URLResponse?, Double) -> Void) {
    ...
    public func sendRequest(uri: String,
        ...
        method: HTTPMethod,
        message: JSONDictionary?,
        handler: @escaping (AnyObject) -> Void) {
        sendRequestDetailed(uri: uri, params: params, method: method, message: message) { json, _, _, _ -> Void in
            handler(json)
        }
    }
    ...
    // GET request, takes a uri and params
    // handler called with json only
    public func sendRequest(uri: String, params: JSONDictionary?, handler: @escaping (AnyObject) -> Void) {
        sendRequest(uri: uri, params: params, method: .GET, message: nil, handler: handler)
    }

    // GET request, takes a uri
    // handler called with json and other info
    public func sendRequestDetailed(uri: String, handler: @escaping (Any, NSURLRequest, URLResponse?, Double) -> Void) {
        sendRequestDetailed(uri: uri, params: nil, handler: handler)
    }

    // GET request, takes a uri
    // handler called with json only
    public func sendRequest(uri: String, handler: @escaping (AnyObject) -> Void) {
    ...
    public var printInfo = {(json: JSONDictionary, request: NSURLRequest, response: URLResponse?, duration: Double) -> Void in
    ...
    public var printJson = {(json: JSONDictionary) -> Void in
        print("json: \(json)")
    }
}
